        ...
        <div class="banner">
            <div class="top_slide_wrap">
                <ul class="slide_box bxslider">
                    ...
                    <li><img src="${ctx}/statics/images/de2.jpg" width="740" height="401"/></li>
                    <li><img src="${ctx}/statics/images/de3.jpg" width="740" height="401"/></li>
                </ul>
